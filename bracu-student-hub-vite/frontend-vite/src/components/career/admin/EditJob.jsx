// src/components/career/admin/EditJob.jsx
...
const EditJob = () => {
  ...
  const fetchJob = async () => {
    try {
      setLoading(true);
      const response = await axios.get(`/api/jobs/admin/${id}`, {
      ...
      if (response.data.success) {
        ...
        setFormData({
          ...
          salary: {
            ...
            period: job.salary?.period || 'hourly'
          },
          responsibilities: job.responsibilities || [''],
          requirements: job.requirements || [''],
          benefits: job.benefits || [''],
          deadline: job.deadline ? job.deadline.split('T')[0] + 'T' + (job.deadline.split('T')[1] || '00:00') : '',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(`/api/jobs/admin/${id}`, submissionData, {
        withCredentials: true,
        headers: {
  ...
  const renderStep1 = () => (
    <div className="form-section">
      <div className="section-header">
        ...
        <p className="section-description">Edit job details</p>
      </div>
  ...
  const renderStep2 = () => (
    <div className="form-section">
      <div className="section-header">
        <h2>Job Details</h2>
        <p className="section-description">Edit job type, location, and salary</p>
      </div>
  ...
  const renderStep3 = () => (
    <div className="form-section">
      <div className="section-header">
        ...
        <p className="section-description">Edit job requirements and benefits</p>
      </div>
  ...
  const renderStep4 = () => (
    <div className="form-section">
      <div className="section-header">
        ...
        <p className="section-description">Edit application details and job settings</p>
      </div>
      ...
      <div className="form-card">
        ...
        <div className="preview-section">
          <h3 className="section-subtitle">👁️ Preview</h3>
          <div className="preview-card">
            ...
            <div className="preview-details">
              <span>💰 {formData.salary.amount ? `$${formData.salary.amount}/hour` : 'Negotiable'}</span>
