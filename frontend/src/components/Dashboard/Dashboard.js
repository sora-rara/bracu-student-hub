...
import GPAStats from './GPA/GPAStats';
import GPAList from './GPA/GPAList';
...
function Dashboard() {
  ...
  const fetchData = async () => {
    try {
      ...
      console.log('Semesters response:', semestersRes);
      console.log('CGPA response:', cgpaRes);
  ...
  // This is the return statement that should be inside the Dashboard function
  return (
